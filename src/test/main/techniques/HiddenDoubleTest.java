...
public void testFindHidden() throws Exception {
	...
	HashMap<String, Integer> freq = new HashMap<>(18);

	HiddenNumbers hiddenDouble = new HiddenDouble();

	hiddenDouble.setCells(row, freq);

	hiddenDouble.findHidden(row, freq);
...
/** 
* 
* Method: setCells(Cell[] cells, HashMap<String, Integer> freq) 
* 
*/ 
@Test
